package com.resourceallocator.honeybee;
...
public  class beeColony implements ResourceAllocatorStrategy{
	...
	return top;
	 ...
	 @Override
		public void runResourceAllocator(String reqMsg) {
			...
			System.out.println("Inside honeybee");
